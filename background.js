...
importScripts(
  'i18n.js', 'ai/position-facts.js', 'ai/prompt-builder.js', 'ai/response-parser.js',
  'ai/providers.js', 'ai/gemini-service.js', 'ai/openai-compatible-service.js', 'ai/ai-service.js'
);
