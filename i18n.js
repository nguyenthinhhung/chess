...
const STRINGS = {
  en: {
    ...
    modePieces: 'Hint',
    modeNone: 'Hidden',
    modeFullTitle: 'Arrows, scores and move review',
    modePiecesTitle: 'Only hint which piece to move — you work out where',
    modeNoneTitle: 'Hide suggestions; analyse only when you tap Explain',
    legendBook: 'Book',
    legendBest: 'Best',
    legend2nd: '2nd',
    legend3rd: '3rd',
  ...
  vi: {
    ...
    minimize: 'Thu nhỏ',
    depth: 'Độ sâu',
    suggestions: 'Số gợi ý',
    displayMode: 'Hiển thị',
    modeFull: 'Đầy đủ',
    modePieces: 'Gợi ý',
    modeNone: 'Ẩn',
    modeFullTitle: 'Mũi tên, điểm số và chấm nước vừa đi',
    modePiecesTitle: 'Chỉ gợi ý nên đi quân nào — bạn tự suy ra đi đâu',
    modeNoneTitle: 'Ẩn gợi ý; chỉ phân tích khi bấm Giải thích',
    legendBook: 'Sách',
    legendBest: 'Tốt nhất',
    legend2nd: 'Thứ 2',
    legend3rd: 'Thứ 3',
