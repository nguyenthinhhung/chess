...
const STRINGS = {
  en: {
    ...
    showHint: 'Show Hint',
    showFull: 'Show full arrows',
    themesLabel: '🧩 Themes',
    themeOppositeCastling: 'opposite-side castling',
    themeOpenFile: 'open %s-file',
    themeIsolated: 'isolated pawn %s',
    themeDoubled: 'doubled pawns (%s-file)',
    themeBackward: 'backward pawn %s',
    themePassed: 'passed pawn %s',
    themeOutpost: 'outpost %s',
    motifMissedLabel: '🎯 Missed tactic',
    motifFoundLabel: '🎯 Tactic',
    motifFork: 'fork',
    motifPin: 'pin',
    motifDiscoveredCheck: 'discovered check',
    motifDoubleCheck: 'double check',
  ...
  vi: {
    ...
    showHint: 'Hiện gợi ý',
    showFull: 'Hiện đầy đủ mũi tên',
    themesLabel: '🧩 Chủ đề',
    themeOppositeCastling: 'nhập thành khác bên',
    themeOpenFile: 'cột %s mở',
    themeIsolated: 'tốt cô lập %s',
    themeDoubled: 'tốt đôi (cột %s)',
    themeBackward: 'tốt lùi %s',
    themePassed: 'tốt thông %s',
    themeOutpost: 'tiền đồn %s',
    motifMissedLabel: '🎯 Bỏ lỡ đòn phối hợp',
    motifFoundLabel: '🎯 Đòn phối hợp',
    motifFork: 'bắt đôi',
    motifPin: 'ghim',
    motifDiscoveredCheck: 'chiếu mở',
    motifDoubleCheck: 'chiếu đôi',
